Feature: Branching Logic
  ...
  And I create a new project named "BranchingLogic_v1115" by clicking on "New Project" in the menu bar, selecting "Operational Support" from the dropdown, choosing file "cdisc_files/projects/DesignForms_v1115.xml", and clicking the "Create Project" button
