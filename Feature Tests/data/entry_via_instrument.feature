Feature: Data Entry through the Data Collection Instrument
  ...
  Scenario: 0 - Create the Project
    ...
    And I create a new project named "Entry Via Instrument" by clicking on "New Project" in the menu bar, selecting "Operational Support" from the dropdown, choosing file "core/07_DesignForms_v1115.xml", and clicking the "Create Project" button
